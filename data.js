// Türkiye illeri ve plaka kodları (1-81)
const PROVINCES = [
...
// İpuçları ve bilgi kartları (öğretici özellik)
const FACTS = [
  { name: 'İstanbul', fact: 'Türkiye’nin en kalabalık şehri ve 34 plaka koduna sahiptir.' },
  { name: 'Ankara', fact: 'Başkentimizdir, plaka kodu 06’dır.' },
  { name: 'İzmir', fact: 'Ege’nin incisi, plaka kodu 35.' },
  { name: 'Bursa', fact: 'Osmanlı’ya başkentlik yapmış, plaka kodu 16.' },
  { name: 'Antalya', fact: 'Turizmin başkenti, plaka kodu 07.' },
];

// Zorluk ayarları
const DIFFICULTIES = {
  easy: { mode: '4sec', timePerQuestion: 12, options: 4, score: 10 },
  medium: { mode: '2sec', timePerQuestion: 10, options: 6, score: 15 },
  hard: { mode: '1sec', timePerQuestion: 8, options: 8, score: 20 },
};

// LocalStorage anahtarı
const STORAGE_KEY = 'plaka-oyunu-skorlar-v1';